...
document.addEventListener('DOMContentLoaded', function() {
    const animatedElements = document.querySelectorAll('.feature-card, .team-member, .faq-item, .stat-card');
...
console.log(`
🎉 Welcome to Queens Networking Society Website!
Built with ❤️ for connecting students and professionals.
